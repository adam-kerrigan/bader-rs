        ...
        let volume =
            lattice.reduced_cartesian_shift_matrix
               ...
               .filter_map(|(vec_i, n)| {
                                  ...
                                  lattice.reduced_cartesian_shift_matrix
                                     ...
                                     .filter_map(|r2| {
                                             ...
                                             invert_lattice(&[*n, *r1, *r2])
                                         {
                                             ...
                                             let vertex_mag =
                                                 vdot(vertex, vertex);
                                             if (vertex_mag - 0.5 * n_mag).abs() < f64::EPSILON {
                                                 return None;
                                             }
                                             ...
                                             for s in lattice.reduced_cartesian_shift_matrix
                                                         .iter()
                                             {
                   ...
                   // calculation later
                   let wedge_volume =
                       vertices.windows(2).fold(0f64, |sum, w| {
                                              sum + vdot(w[0], cross(w[1], *n))
                                          })
                       / 12f64;
                   ...
                   alphas.push(alpha);
                   vectors.push(lattice.reduced_grid_shift_matrix[26 - vec_i].clone());
                   alphas.push(alpha);
